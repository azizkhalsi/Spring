...
RUN apk add --no-cache curl \
    && curl -u ${NEXUS_USERNAME}:${NEXUS_PASSWORD} -O http://192.168.33.10:8081/repository/springproject/com/projet/tpAchatProject/0.0.1-SNAPSHOT/tpAchatProject-0.0.1-20241027.114618-1.jar
